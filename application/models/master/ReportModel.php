...
class ReportModel extends CI_Model 
{
    ...
    public function  progresoPorSeccion($trimestre=null,$codProfesor=null)
    {
        $response=null;
        $ur=web_service_uri.'/reporte/progresoPorSeccion?trimestre='.$trimestre.'&codProfesor='.$codProfesor;
        try {                 
            $response = \Httpful\Request::get($ur)->send();
            $response=json_decode($response,true);
            return $response;
